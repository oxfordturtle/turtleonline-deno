...
import { Expression, CompoundExpression, IntegerValue, StringValue, InputValue, ColourValue, ConstantValue, VariableAddress, VariableValue, CastExpression } from './definitions/expression.ts'
