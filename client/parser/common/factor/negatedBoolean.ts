...
const parseNegatedBoolean = (
  ...
  const checkedExpression = typeCheck(routine.language, expression, "boolint");
  return makeCompoundExpression(lexeme, null, checkedExpression, "not");
};

export default parseNegatedBoolean;
