...
const main = (feedback?: FeedbackProps): JSX.Element => (
  <>
    ...
    <p>
      Are you sure you want to delete your account? All of your details and
      files on our server will be deleted, and this action cannot be undone. You
      can sign up again for a new account at any time.
    </p>
    <div className="form">
      <form method="post">
