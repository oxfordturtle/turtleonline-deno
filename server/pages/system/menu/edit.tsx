  ...
  <>
    <div className="system-sub-menu">
      ...
      <div className="system-sub-menu" data-system-menu="edit">
        ...
        <hr />
        <a data-action="selectAll" data-mode="normal,expert,machine">
          <span>Select All</span>
        </a>
        <a data-action="findAndReplace">
          <span>Find and replace</span>
        </a>
        <hr />
        <a data-action="autoFormat">
          <span>Auto-format program</span>
        </a>
        <hr data-mode="normal,expert,machine" />
        <a data-action="storeCopy" data-mode="normal,expert,machine">
          <span>Store copy of program</span>
        </a>
        <a data-action="restoreCopy" data-mode="normal,expert,machine">
