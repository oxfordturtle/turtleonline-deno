...
const Body = ({ requestParams, headerContent, mainContent }: { requestParams: RequestParams, headerContent: JSX.Element, mainContent: JSX.Element }): JSX.Element =>
    ...
    <div className="site-nav-left">
      <div className="site-menu">
        <a data-action="toggleMenu" data-arg="site">
          <span className="icon logo"><img src="/images/turtle.png" alt="turtle logo" /></span>
        ...
        <div className="site-sub-menu" data-menu="site">
          ...
          <div className="site-menu">
            <a className={requestParams.sections[0] === "documentation" ? "active" : ""} data-action="toggleMenu" data-arg="documentation">
              <span className="icon"><i className="fa fa-book"></i></span>
              <span className="text">Documentation</span>
              <span className="icon"><i className="fa fa-caret-down"></i></span>
            </a>
            <div className="site-sub-menu" data-menu="documentation">
              <a href="/documentation/system" className={requestParams.page === "system" ? "active" : ""}>Turtle System User Guide</a>
              <a href="/documentation/help" className={requestParams.page === "help" ? "active" : ""}>Turtle Languages Help</a>
              <a href="/documentation/reference" className={requestParams.page === "reference" ? "active" : ""}>Commands &amp; Constants Reference</a>
              <a href="/documentation/exercises" className={requestParams.page === "exercises" ? "active" : ""}>Self-Teach Exercises</a>
              <a href="/documentation/machine" className={requestParams.page === "machine" ? "active" : ""}>Turtle Machine Specification</a>
              <a href="/documentation/languages" className={requestParams.page === "languages" ? "active" : ""}>Turtle Language Specifications</a>
              <a href="/documentation/csac" className={requestParams.page === "csac" ? "active" : ""}>Computer Science Across the Curriculum</a>
              <a href="/documentation/reading" className={requestParams.page === "reading" ? "active" : ""}>Further Reading</a>
            </div>
          </div>
...
const LoggedInNav = ({ requestParams, username }: { requestParams: RequestParams, username: string }): JSX.Element =>
  <div className="site-menu">
    <a className={requestParams.sections[0] === "account" ? "active" : ""} data-action="toggleMenu" data-arg="user">
      <span className="icon"><i className="fa fa-user" aria-hidden="true"></i></span>
      <span className="text">{username}</span>
      <span className="icon"><i className="fa fa-caret-down" aria-hidden="true"></i></span>
    </a>
    <div className="site-sub-menu" data-menu="user">
      <a href="/account" className={requestParams.page === "account" ? "active" : ""}>My Account</a>
      <a href="/account/files" className={requestParams.page === "files" ? "active" : ""}>My Files</a>
...
const LoggedOutNav = ({ requestParams }: { requestParams: RequestParams }): JSX.Element =>
  <>
    <a href="/register" className={requestParams.sections[0] === "register" ? "active" : ""}>
      <span className="icon"><i className="fa fa-user-plus"></i></span>
      <span className="text">Register</span>
    </a>
    <a href="/login" className={requestParams.sections[0] === "login" ? "active" : ""}>
      <span className="icon"><i className="fa fa-sign-in-alt"></i></span>
