...
const forgotResponse = (requestParams: RequestParams, feedback?: FeedbackProps): Promise<Response> =>
...
const handleForm = async (requestParams: RequestParams, imp: Imp): Promise<Response> => {
  ...
  if (requestParams.formData === undefined) {
    return forgotResponse(requestParams, { ok: false, message: "You didn't submit any form data." })
  }
  ...
  // validate form data
  if (!email) {
    return forgotResponse(requestParams, { ok: false, message: "Email address is required." })
  }
  ...
  if (!user) {
    return forgotResponse(requestParams, { ok: false, message: "Email address not found." })
  }
  ...
  if (result[0] === "left") {
    ...
    return forgotResponse(requestParams, { ok: false, message: "Couldn't send email. Please try again later." })
  }
  ...
  return forgotResponse(requestParams, { ok: true, message: "An email has been sent to your address." })
}
