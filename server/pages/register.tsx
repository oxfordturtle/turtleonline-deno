...
const handleForm = async (
  ...
  const accountTypeNumber = accountTypeString
    ? parseInt(accountTypeString)
    : undefined;
  const accountType =
  ...
  if (accountType === 2 && !guardian) {
    return registerResponse(requestParams, {
      ok: false,
      message: "Full name of parent/guardian is required.",
    });
  }
...
const header = (
  <>
    <h1>Register</h1>
    <p>
      Creating an account on this site is free and easy. Simply fill in the form
      below and click ‘Register’. You will then be able to upload and share your
      Turtle programs with others, save your online system preferences, create
      and join programming courses, and access our free course materials.
    </p>
  </>
);
