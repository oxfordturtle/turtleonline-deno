...
const main = (searchParams: URLSearchParams): JSX.Element =>
  <div id="turtle" className="system" data-language={searchParams.get("l")} data-example={searchParams.get("x")} data-file={searchParams.get("f")} data-fullscreen={searchParams.get("f")}>
    <header className="system-header">
      <button aria-label="system menu" data-action="toggleMenu" data-arg="system"><i className="fa fa-bars" aria-hidden="true"></i></button>
      <Controls />
    </header>
