...
export type ErrorCode = Status.NotFound | Status.MethodNotAllowed | Status.BadRequest | Status.InternalServerError | Status.Forbidden
...
const forbidden = (requestParams: RequestParams): string =>
  page(requestParams, <h1>Login Required</h1>, <p>This page is for registered users only. Please register or sign up for a free account.</p>)
