...
export default (requestParams: RequestParams, imp: Imp): Response => {
  return requestParams.sections[1] === undefined
    ? redirectResponse(`${requestParams.url.origin}/documentation/system`)
    : handler[requestParams.sections[1]] ? handler[requestParams.sections[1]](requestParams, imp) : error(requestParams, Status.NotFound)
}

const handler: Record<string, (requestParams: RequestParams, imp: Imp) => Response> = {
  csac,
  exercises,
  help,
  languages,
